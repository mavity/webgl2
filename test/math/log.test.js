...
test('Math Builtin: log', async (t) => {
    ...
    const testValues = [1.0, Math.E, 2.0, 10.0, 0.5];
    ...
    for (const val of testValues) {
        ...
        assert.equal(canonicalize(result), canonicalize(expected), `log(${val}) failed`);
    }
});
