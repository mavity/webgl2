...
test('WebGL2 vertexAttribI* rendering', { skip: true }, async (t) => {
    ...
    await t.test('constant attributes', { skip: true }, async () => {
    ...
    await t.test('vertexAttribIPointer i32', async () => {
      const gl = await webGL2();
      try {
        gl.viewport(0, 0, 640, 480);
    ...
    await t.test('vertexAttribIPointer u32', { skip: true }, async () => {
      const gl = await webGL2();
      try {
        gl.viewport(0, 0, 640, 480);
    ...
    await t.test('vertexAttribIPointer small types', async () => {
      const gl = await webGL2();
      try {
        gl.viewport(0, 0, 640, 480);
