...
| src/webgpu/backend.rs | 26/50 | [943] `}` | 48.00% 🟠 |
| src/decompiler/lifter.rs | 21/38 | [455] `fn unary_op(&mut self, op: UnaryOp) {` | 44.74% 🟠 |
| src/naga_wasm_backend/expressions.rs | 19/74 | [977] `let var = &ctx.module.global_variables[*handle];` | 74.32% 🟡 |
