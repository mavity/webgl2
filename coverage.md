...
| **Total** | **535** | **126** | **661** | **80.94% 🟢** |

## Top Missed Files

| File | Lines Missed | Illustrative Line | Coverage |
|---|---|---|---:|
| src/lib.rs | 28/140 | [516] `pub extern "C" fn wasm_ctx_uniform1f(ctx: u32, location: ...` | 80.00% 🟢 |
| src/webgpu/backend.rs | 26/50 | [919] `}` | 48.00% 🟠 |
| src/naga_wasm_backend/expressions.rs | 23/66 | [940] `let var = &ctx.module.global_variables[*handle];` | 65.15% 🟡 |
