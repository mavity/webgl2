...
- [ ] Add `calculate_type_size()` helper using Naga's type system
- [ ] Implement `PrivateMemoryLayout` struct
- [ ] Replace hardcoded 2048 with `layout.locals_start`
- [ ] Replace hardcoded 4096 with `layout.frag_depth_offset`
- [ ] Add validation in `compile_function()`
- [ ] Update snapshot tests with new WAT layouts
- [ ] Document layout in `output_layout.rs`
- [ ] Add runtime assertions in JS bindings
